...
const isRoomChangeSuccessful = computed(() => Boolean(props.changeRoomSuccess));
</script>
  ...
  >
    <template #content>
      <div
        :class="[
          $style.content,
          isRoomChangeSuccessful ? $style.contentSuccess : undefined,
        ]"
      >
        <template v-if="isRoomChangeSuccessful">
