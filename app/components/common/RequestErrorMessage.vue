...
export const REQUEST_ERROR_MESSAGES: Record<number, RequestErrorContent> = {
  400: {
    ...
    detail: "Сервер временно не смог обработать запрос. Повторите попытку позднее.",
  },
  401: {
    summary: "Требуется авторизация",
    detail: "Авторизуйтесь, чтобы продолжить. Если ошибка повторяется, обновите страницу.",
  },
  403: {
    summary: "Доступ ограничен",
    detail: "У вас нет прав для выполнения запроса. Проверьте учетную запись или обратитесь в поддержку.",
  },
  404: {
    summary: "Данные не найдены",
    detail: "Запрашиваемая информация недоступна. Попробуйте изменить параметры поиска.",
  },
  408: {
    summary: "Время ожидания истекло",
    detail: "Сервер не ответил вовремя. Проверьте соединение и попробуйте снова.",
  },
  409: {
  ...
  429: {
    ...
    detail: "Снизьте частоту запросов и повторите попытку через несколько минут.",
  },
  500: {
    summary: "Технические неполадки",
    detail: "На сервере произошла ошибка. Наши специалисты уже работают над решением.",
  },
  502: {
  ...
  503: {
    ...
    detail: "Сервис временно отключен на обслуживание. Повторите попытку позже.",
  },
  504: {
    summary: "Таймаут шлюза",
    detail: "Ответ от сервера не был получен вовремя. Повторите запрос позднее.",
  },
};
